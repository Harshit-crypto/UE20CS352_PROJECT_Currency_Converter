...
public class Controller {
    ...
    public void initialize() {
        ...
        convertTo.getSelectionModel().select("INR");
    ...
    public void convert() throws IOException {
        ...
        if (exchangeRate >= 0) {
            rate.setText(""+ amount.getValue()+ "@"+ exchangeRate +"  ="+ exchangeRate* amount.getValue());
        } else {
            throw new IOException("getRate() error");
        }
    }

    private double getRate(String from, String to) throws IOException {
        try {
            ...
            if (response.code() != 200) {
                ...
                String responseBody = sc.next();
                String exchangeRateString = responseBody.substring(responseBody.indexOf(to) + 5, responseBody.indexOf("}"));
